...
var youdao_conv_id = 271546; 
 ...
 $(document).ready(function(){
 	$("#JOBCOLL").click(function(){
 		$("#JOBCOLL").css("background-image","url(style/css/img/collection_icon_s.png)");
 		$("#JOBCOLLSUCCESS").show();
 		$.post("inserFavor.action",{"reciritmentId":$("#ZZID").val()},function(data){});
 	});
 });
function TOU(id){
	$.post("sendResume.action",{"reciritmentId":id},function(data){alert("投递成功!");});
}
 </script>
 <s:if test="#request.isFavors">
 	<script>
 		$("#JOBCOLL").css("background-image","url(style/css/img/collection_icon_s.png)");
 	</script>
 </s:if>
   ...
   <div id="container"> 
    <div class="clearfix"> 
     <div class="content_l"> 
      <dl class="job_detail"> 
       <dt> 
        <h1 title="<s:property value="#request.detailsReciritment.company.name"/>招聘 "> <em></em> 
         <div>
           	<s:property value="#request.detailsReciritment.company.name"/>招聘 
         </div> </h1> 
        <div class="jd_collection" id="JOBCOLL"> 
         <div class="jd_collection_success" id="JOBCOLLSUCCESS"> 
          <span>已成功收藏该职位，</span> 
       ...
       <dd class="job_request"> 
        <span class="red"><s:property value="#request.detailsReciritment.minSalary"/>k-<s:property value="#request.detailsReciritment.maxSalary"/>k</span> 
        <span><s:property value="#request.detailsReciritment.city"/></span>
      	 <input type="hidden" name="ZZID" id="ZZID" value="<s:property value="#request.detailsReciritment.id"/>" /> 
        <s:set name="JOBEXP" value="{'工作经验不限','应届生','1年以下','1-3年','3-5年','5-10年','10年以上'}"/>
        <span><s:property value="#JOBEXP[#request.detailsReciritment.jobExperience]"/></span> 
        <s:set name="DEGREE" value="{'不限','大专及以下','本科','硕士','博士'}"/>
        <span><s:property value="#DEGREE[#request.detailsReciritment.degree]"/></span> 
        <s:set name="JOBTYPE" value="{'全职','兼职','实习'}"/>
        <span><s:property value="#DEGREE[#request.detailsReciritment.jobType]"/></span> 
        <br /> 职位诱惑 : <s:property value="#request.detailsReciritment.tag"/>
        <div>
         	 发布时间：<s:property value="#request.detailsReciritment.sendDate"/>发布 
        </div> 
       </dd> 
       <dd class="job_bt"> 
        <h3 class="description">职位描述</h3>
        	<s:property value="#request.detailsReciritment.description"/>
       </dd> 
     
        <!-- 用户是否激活 0-否；1-是 --> 
        <a  class="btn fr btn_apply" onclick="TOU(<s:property value="#request.detailsReciritment.id"/>);">投个简历</a> 
     ...
     <div class="content_r"> 
      <dl class="job_company"> 
       <dt> 
        <a target="_blank" href="c/19607.jsp"> <img width="80" height="80" alt="<s:property value="#request.detailsReciritment.company.name"/>" src="<<s:property value="#request.detailsReciritment.company.logo"/>>" class="b2" /> 
         <div> 
          <h2 class="fl"> <s:property value="#request.detailsReciritment.company.name"/> <img width="15" height="19" alt="拉勾认证企业" src="style/images/valid.png" /> <span class="dn">认证企业</span> </h2> 
         </div> </a> 
       </dt> 
       <dd> 
        <ul class="c_feature reset"> 
         <li><span>领域</span> <s:property value="#request.detailsReciritment.company.field"/></li> 
         
         <li><span>规模</span> <s:property value="#request.detailsReciritment.company.size"/></li> 
         <li> <span>主页</span> <a rel="nofollow"  href="http://<s:property value="#request.detailsReciritment.company.webSite"/>">http://<s:property value="#request.company.webSite"/></a> </li> 
        </ul> 
        ...
        <h4>工作地址</h4> 
        <div>
     	 <s:property value="#request.detailsReciritment.company.location"/>
        </div> 
        <div id="smallmap" style="overflow: hidden; position: relative; z-index: 0; background-color: rgb(243, 241, 236); color: rgb(0, 0, 0); text-align: left;"> 
         <div style="overflow: visible; position: absolute; z-index: 0; left: 0px; top: 0px; cursor: grab;"> 
          <div class="BMap_mask" style="position: absolute; left: 0px; top: 0px; z-index: 9; overflow: hidden; width: 280px; height: 200px;"></div> 
          <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 200;"> 
           ...
           <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 700;"> 
            <span style="position: absolute; padding: 0px; margin: 0px; border: 0px none; -moz-user-select: none; cursor: pointer; background: url(style/images/img/blank.gifquot) repeat scroll 0% 0% transparent; width: 19px; height: 25px; left: 130px; top: 75px; z-index: -4625058;" "="" unselectable="on" class="BMap_Marker BMap_noprint" title=""></span> 
           </div> 
           ...
           <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 500;"> 
            <label class="BMapLabel" unselectable="on" style="position: absolute; -moz-user-select: none; display: none; cursor: inherit; background-color: rgb(190, 190, 190); border: 1px solid rgb(190, 190, 190); padding: 1px; white-space: nowrap; font: 12px arial,simsun,sans-serif; z-index: -20000; color: rgb(190, 190, 190);">shadow</label> 
           </div> 
           <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 400;"> 
            <span style="position: absolute; padding: 0px; margin: 0px; border: 0px none; width: 0px; height: 0px; -moz-user-select: none; left: 130px; top: 75px; z-index: -4625058;" unselectable="on" class="BMap_Marker"> 
             <div style="position: absolute; margin: 0px; padding: 0px; width: 19px; height: 25px; overflow: hidden;"> 
              <img style="border:none;margin-left:0px; margin-top:0px; " src="style/images/marker_red_sprite.png" /> 
             </div></span> 
           </div> 
           <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 300;"> 
            <span style="position: absolute; padding: 0px; margin: 0px; border: 0px none; width: 20px; height: 11px; -moz-user-select: none; left: 134px; top: 89px;" unselectable="on"> 
             <div style="position: absolute; margin: 0px; padding: 0px; width: 20px; height: 11px; overflow: hidden;"> 
              <img style="border:none;margin-left:-19px; margin-top:-13px; " src="style/images/marker_red_sprite.png" /> 
             </div></span> 
           </div> 
          ...
          <div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 2; display: block;"> 
           <div style="position: absolute; overflow: visible; top: 100px; left: 140px; z-index: 0; display: block;"> 
            <canvas style="position: absolute; width: 256px; height: 256px; left: -156px; top: -103px; background: none repeat scroll 0% 0% rgb(243, 241, 236);" width="256" height="256" id="_1_bg_12319_2568_16"></canvas> 
            <canvas style="position: absolute; width: 256px; height: 256px; left: 100px; top: -103px; background: none repeat scroll 0% 0% rgb(243, 241, 236);" width="256" height="256" id="_1_bg_12320_2568_16"></canvas> 
           </div> 
           <div style="position: absolute; overflow: visible; top: 100px; left: 140px; z-index: 10; display: block;"> 
            <canvas style="position: absolute; width: 256px; height: 256px; left: -156px; top: -103px;" width="256" height="256" id="_1_poi_12319_2568_16"></canvas> 
            <canvas style="position: absolute; width: 256px; height: 256px; left: 100px; top: -103px;" width="256" height="256" id="_1_poi_12320_2568_16"></canvas> 
           </div> 
          </div> 
          <div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 3;"></div> 
         </div> 
         <div style="position: absolute; z-index: 1201; top: 10px; right: 10px; width: 17px; height: 16px; background: url(style/images/img/st-close.pngquot) no-repeat scroll 0% 0% transparent; cursor: pointer; display: none;" title="退出全景"></div> 
         ...
         <div style="height: 32px; position: absolute; z-index: 30; -moz-user-select: none; bottom: 0px; right: auto; top: auto; left: 1px; display: none;" class=" anchorBL"> 
          <a title="到百度地图查看此区域" target="_blank" href="http://map.baidu.com/?sr=1" style="outline: medium none;"><img src="style/images/copyright_logo.png" style="border:none;width:77px;height:32px" /></a> 
         </div> 
         <div unselectable="on" class=" BMap_cpyCtrl BMap_noprint anchorBL" style="cursor: default; white-space: nowrap; -moz-user-select: none; color: black; background: none repeat scroll 0% 0% transparent; font: 11px/15px arial,simsun,sans-serif; bottom: 2px; right: auto; top: auto; left: 4px; position: absolute; z-index: 10;"> 
          <span _cid="1" style="display: inline;"><span style="font-size:11px">&copy; 2014 Baidu&nbsp;- Data &copy; <a style="display:inline;" href="http://www.navinfo.com/" target="_blank">NavInfo</a> &amp; <a style="display:inline;" href="http://www.cennavi.com.cn/" target="_blank">CenNavi</a> &amp; <a style="display:inline;" href="http://www.365ditu.com/" target="_blank">道道通</a></span></span> 
         </div> 
        </div> 
      ...
      <div id="myRecommend_jd"> 
       ...
       <ul class="reset"> 
        <li> <a target="_blank" href="jobs/22194.jsp"> <span class="f14">产品经理</span> <span class="c7">A</span> <em>92%</em> </a> </li> 
        <li> <a target="_blank" href="jobs/148004.jsp"> <span class="f14">产品经理</span> <span class="c7">B</span> <em>92%</em> </a> </li> 
        <li> <a target="_blank" href="jobs/46793.jsp"> <span class="f14">产品经理</span> <span class="c7">C</span> <em>89%</em> </a> </li> 
        <li> <a target="_blank" href="jobs/99307.jsp"> <span class="f14">产品经理</span> <span class="c7">D</span> <em>88%</em> </a> </li> 
        <li> <a target="_blank" href="jobs/147510.jsp"> <span class="f14">产品经理</span> <span class="c7">E</span> <em>88%</em> </a> </li> 
       </ul> 
       <a target="_blank" class="more" href="mList.jsp">更多推荐职位&gt;&gt;</a> 
      </div> 
      <!--end #myRecommend--> 
      <a class="eventAd" target="_blank" href="subject/s_zhouyou.jsp?utm_source=BD__lagou&amp;utm_medium=&amp;utm_campaign=zhouyou"> <img width="280" height="135" src="style/images/zhouyou.jpg" /> </a> 
     </div> 
    </div> 
        ...
        <tr> 
         <td> 
          <form class="resumeSetForm" id="resumeSetForm"> 
           <label class="radio"> <input type="radio" checked="" value="1" class="resume1" name="resumeName" /> 在线简历： <span title="jason的简历">jason的简历</span> </label> 
           <div class="setBtns"> 
            <a target="_blank" href="resume/preview.jsp">预览</a> | 
            <a target="_blank" href="resume/myresume.jsp">修改</a> 
           </div> 
           <div class="clear"></div> 
           <label class="radio"> <input type="radio" value="0" class="resume0" name="resumeName" /> 附件简历： <span class="uploadedResume red">暂无附件简历</span> </label> 
           <div class="setBtns"> 
            <a class="downloadResume dn" href="nearBy/downloadResume">下载</a> 
            <span class="dn">|</span> 
      ...
      <table width="100%"> 
       <tbody> 
        <tr> 
         <td align="center"> 
          <form> 
           <a class="btn_addPic" href="javascript:void(0);"> <span>选择上传文件</span> <input type="file" onchange="file_check(this,'nearBy/updateMyResume.json','resumeUpload')" class="filePrew" id="resumeUpload" name="newResume" size="3" title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M" tabindex="3" /> </a> 
          </form> </td> 
        </tr> 
        <tr> 
    ...
    #colorbox, #cboxOverlay, #cboxWrapper{overflow:visible;}
       ...
       <table width="100%"> 
        <tbody> 
         <tr> 
          ...
          <td valign="middle"> <span class="redstar">*</span> </td> 
          <td> <input type="hidden" id="degree" value="" name="degree" /> <input type="button" value="最高学历" id="select_degree" class="profile_select_190 profile_select_normal" /> 
           <div class="boxUpDown boxUpDown_190 dn" id="box_degree" style="display: none;"></div> </td> 
         </tr> 
         <tr> 
          <td valign="middle"> <span class="redstar">*</span> </td> 
          <td> <input type="hidden" id="workyear" value="" name="workyear" /> <input type="button" value="工作年限" id="select_workyear" class="profile_select_190 profile_select_normal" /> 
           <div class="boxUpDown boxUpDown_190 dn" id="box_workyear" style="display: none;"></div> </td> 
          <td valign="middle"> <span class="redstar">*</span> </td> 
          <td> <input type="hidden" id="expectCity" value="" name="expectCity" /> <input type="button" value="期望工作城市" id="select_expectCity" class="profile_select_190 profile_select_normal" /> 
           <div class="boxUpDown boxUpDown_596 dn" id="box_expectCity" style="display: none;"></div> </td> 
         </tr> 
         <tr> 
          <td valign="middle"> <span class="redstar">*</span> </td> 
          <td> <input type="text" placeholder="联系电话" name="tel" /> </td> 
          <td valign="middle"> <span class="redstar">*</span> </td> 
          <td> <input type="text" placeholder="邮箱地址" name="email" /> </td> 
         </tr> 
         <tr> 
          <td></td> 
          <td colspan="3"> <input type="hidden" value="" name="type" /> <input type="submit" value="确认并投递" class="btn" /> </td> 
         </tr> 
        </tbody> 
       </table> 
      </form> 
     ...
     <div class="popup" id="deliverResumeConfirm"> 
      <table width="100%"> 
       <tbody> 
        ...
        <tr> 
         <td align="center"> <input type="hidden" value="" name="type" /> <a class="btn" href="javascript:sendResume(314873,149487,true,true);">确认投递</a> <a class="btn_s" href="javascript:;">放弃投递</a> <a class="f20 edit_field" href="javascript:;">修改信息</a> </td> 
        </tr> 
       </tbody> 
      </table> 
     </div> 
     ...
     <div style="width:440px;padding-bottom:10px;" class="popup" id="deliverResumesSuccess"> 
      <table width="100%"> 
       <tbody> 
        <tr class="drawGGJ"> 
         <td align="center"> <p class="font_16 count"></p> <p class="font_16 share dn">邀请好友成功注册，可提升每日投递量 &nbsp;&nbsp; <a target="_blank" href="share/invite.jsp">邀请好友&gt;&gt;</a></p> </td> 
        </tr> 
        <tr class="drawQD"> 
         <td align="center"><a class="btn_s" href="javascript:top.location.reload();">确&nbsp;定</a></td> 
        </tr> 
      ...
      <table width="100%"> 
       <tbody> 
        ...
        <tr> 
         <td align="center"> 
          <form> 
           <a class="btn_addPic" href="javascript:void(0);"> <span>选择上传文件</span> <input type="file" onchange="file_check(this,'nearBy/updateMyResume.json','resumeUpload2')" class="filePrew" id="resumeUpload2" name="newResume" size="3" title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M" /> </a> 
          </form> <a target="_blank" href="resume/basic.jsp" class="btn">完善在线简历</a> </td> 
        </tr> 
       </tbody> 
      </table> 
     </div> 
      ...
      <table width="100%"> 
       <tbody> 
        ...
        <tr> 
         <td align="center"> 
          <form> 
           <a class="btn_addPic" href="javascript:void(0);"> <span>选择上传文件</span> <input type="file" onchange="file_check(this,'nearBy/updateMyResume.json','resumeUpload1')" class="filePrew" id="resumeUpload1" name="newResume" size="3" title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M" /> </a> 
          </form> </td> 
        </tr> 
        <tr> 
	...
	--> 
     <div class="popup" id="resend_success"> 
      <p>我们已将激活邮件发送至：<a>1611456615@qq.com</a>，请点击邮件内的链接完成验证。</p> 
     </div> 
     <!--/#resend_success--> 
     <!--地图弹窗--> 
     <div class="popup" id="baiduMap"> 
      <div id="allmap" style="overflow: hidden; position: relative; z-index: 0; background-color: rgb(243, 241, 236); color: rgb(0, 0, 0); text-align: left;"> 
       <div style="overflow: visible; position: absolute; z-index: 0; left: 0px; top: 0px; cursor: grab;"> 
        <div class="BMap_mask" style="position: absolute; left: 0px; top: 0px; z-index: 9; overflow: hidden; width: 0px; height: 0px;"></div> 
        <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 200;"> 
         <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 800;"></div> 
       ...
       <div unselectable="on" class=" BMap_stdMpCtrl BMap_stdMpType0 BMap_noprint anchorTL" style="width: 62px; height: 186px; bottom: auto; right: auto; top: 10px; left: 10px; position: absolute; z-index: 1100; -moz-user-select: none;"> 
       ...
       <div unselectable="on" style="bottom: auto; right: 10px; top: 10px; left: auto; white-space: nowrap; cursor: pointer; position: absolute; z-index: 10; -moz-user-select: none;" class=" BMap_noprint anchorTR"> 
        <div style="-moz-user-select: none; float: left;"> 
         <div style="-moz-user-select: none; box-shadow: 2px 2px 3px rgba(0, 0, 0, 0.35); border-left: 1px solid rgb(139, 164, 220); border-top: 1px solid rgb(139, 164, 220); border-bottom: 1px solid rgb(139, 164, 220); background: none repeat scroll 0% 0% rgb(142, 168, 224); padding: 2px 6px; font: bold 12px/1.3em arial,simsun,sans-serif; text-align: center; white-space: nowrap; border-radius: 3px 0px 0px 3px; color: rgb(255, 255, 255);" title="显示普通地图">
           地图 
         </div> 
        </div> 
        <div style="-moz-user-select: none; float: left;"> 
         <div style="-moz-user-select: none; box-shadow: 2px 2px 3px rgba(0, 0, 0, 0.35); border-left: 1px solid rgb(139, 164, 220); border-top: 1px solid rgb(139, 164, 220); border-bottom: 1px solid rgb(139, 164, 220); background: none repeat scroll 0% 0% rgb(255, 255, 255); padding: 2px 6px; font-family: arial,simsun,sans-serif; font-style: normal; font-variant: normal; font-size: 12px; line-height: 1.3em; font-size-adjust: none; font-stretch: normal; -moz-font-feature-settings: normal; -moz-font-language-override: normal; text-align: center; white-space: nowrap; color: rgb(0, 0, 0);" title="显示卫星影像">
           卫星 
         </div> 
         <div style="-moz-user-select: none; position: absolute; top: 0px; left: 0px; z-index: -1; display: none;"> 
          <div style="border-right:1px solid #8ba4dc;border-bottom:1px solid #8ba4dc;border-left:1px solid #8ba4dc;background:white;font:12px arial,simsun,sans-serif;padding:0 8px 0 6px;line-height:1.6em;box-shadow:2px 2px 3px rgba(0, 0, 0, 0.35)" title="显示带有街道的卫星影像"> 
        ...
        <div style="-moz-user-select: none; float: left;"> 
         <div style="-moz-user-select: none; box-shadow: 2px 2px 3px rgba(0, 0, 0, 0.35); border-left: 1px solid rgb(139, 164, 220); border-width: 1px; border-style: solid; border-color: rgb(139, 164, 220); background: none repeat scroll 0% 0% rgb(255, 255, 255); padding: 2px 6px; font-family: arial,simsun,sans-serif; font-style: normal; font-variant: normal; font-size: 12px; line-height: 1.3em; font-size-adjust: none; font-stretch: normal; -moz-font-feature-settings: normal; -moz-font-language-override: normal; text-align: center; white-space: nowrap; border-radius: 0px 3px 3px 0px; color: rgb(0, 0, 0);" title="显示三维地图">
           三维 
         </div> 
        </div> 
       </div> 
       <div unselectable="on" class=" BMap_omCtrl BMap_ieundefined BMap_noprint anchorBR quad4" style="width: 13px; height: 13px; bottom: 0px; right: 0px; top: auto; left: auto; position: absolute; z-index: 10; -moz-user-select: none;"> 
...
$(function(){
    ...
    <script src="http://api.map.baidu.com/api?v=2.0&amp;ak=3d6a9f4b807441569414b01eecc20959" type="text/javascript"></script> 
    <script src="http://api.map.baidu.com/getscript?v=2.0&amp;ak=3d6a9f4b807441569414b01eecc20959&amp;services=&amp;t=20140617153133" type="text/javascript"></script> 
    <script type="text/javascript">
		//百度地图API功能
