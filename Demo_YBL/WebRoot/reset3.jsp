...
<html>
  ...
  <body id="login_bg">
    <div class="login_wrapper">
      ...
      <div class="find_psw">
        <img src="style/images/img/RESET3.png" width="380" height="40" alt="找回密码第三步" />
        <form id="pswForm" action="resetPassword3.action" method="post">
          <input type="password" name="password" id="email" tabindex="1" value="" placeholder="请输入新密码" />
