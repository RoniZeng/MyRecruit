...
var youdao_conv_id = 271546; 
 ...
 <body>
  ...
  <div id="body"> 
   <div id="header"> 
    <div class="wrapper"> 
     <a class="logo" href="index.jsp"> <img width="229" height="43" alt="招聘-专注互联网招聘" src="style/images/logo.png" /> </a> 
   ...
   <div id="container"> 
    <div class="sidebar"> 
     ...
     <div class="subscribe_side mt20"> 
      ...
      <div>
       咨询：
       <a class="f16" href="mailto:jessica@lagou.com">jessica@ybl.com</a>
      </div> 
      <div class="f18 ti2em">
       010-123456789
      </div> 
    ...
    <div class="content"> 
     <dl class="company_center_content"> 
      ...
      <dd> 
       <div class="ccc_tr">
        今日已发布 
        <span>1</span> 个职位 还可发布 
        <span>4</span> 个职位
       </div> 
       <div class="publish_tip"> 
        <h2>恭喜你，职位发布成功！</h2> 
        <a target="_blank" href="#">预览职位</a>
        <br /> 
        <a class="greylink" href="create.jsp">继续发布新职位</a>
        <br /> 
        <a class="greylink" href="#"> 进入我的公司主页</a>
        <br /> 
       ...
       <div class="weixin weixinSuc"> 
        ...
        <div class="qr_text"> 
         <h3>关注微信服务号，可随时获取接收简历的通知 </h3> 关注方式：
         <br /> 
         <span>打开微信 </span> 
         <img width="30" height="30" src="style/images/wx1.png" />
         <span> →发现 </span> 
         <img width="31" height="30" src="style/images/wx2.png" />
         <span> →扫一扫左侧二维码</span>
         <img width="78" height="29" src="style/images/wx3.png" /> 
        </div> 
       </div> 
      </dd> 
     </dl> 
...
function popQR(){
  ...
  <div id="footer"> 
   <div class="wrapper"> 
    ...
    <a target="_blank" href="http://www.lagou.com/af/zhaopin.jsp">公司导航</a> 
