...
<html xmlns:wb="http://open.weibo.com/wb">
 <head> 
  ...
  <title>产品经理-广州百田-医伯乐-最专业的医药招聘平台</title> 
...
var youdao_conv_id = 271546; 
 ...
 <body> 
  <div id="body"> 
   <div id="header"> 
    <div class="wrapper"> 
     <a class="logo" href="h/"> <img width="229" height="43" alt="拉勾招聘-专注互联网招聘" src="style/images/logo.png" /> </a> 
    ...
    <div class="clearfix"> 
     <div class="content_l"> 
      <dl class="job_detail"> 
       <dt> 
        ...
        <div class="jd_collection" id="jobCollection"> 
         <div class="jd_collection_success"> 
          <span>已成功收藏该职位，</span> 
          <a class="jd_collection_page" href="collections.jsp">查看全部</a> 
       ...
       <dd class="resume resume_web"> 
        <div> 
         <span> 你已有可投递的在线简历：<a title="jason的简历" target="_blank" href="jianli.jsp"><strong>jason的简历</strong></a></span>
         <br /> 
         <span>简历更新于2014-07-01 15:53</span> 
        </div> 
        <span class="setBtns"> <a target="_blank" title="预览" href="h/resume/preview.jsp">预览</a> | <a title="修改" target="_blank" href="jianli.jsp">修改</a> </span> 
       </dd> 
       <div class="saoma saoma_btm"> 
        <div class="dropdown_menu"> 
         ...
         <div class="drop_r"> 
          ...
          <p> 想知道HR在看简历嘛？<br /> 想在微信中收到面试通知？<br /> <span>&lt;&lt; 扫一扫，给你解决</span> </p> 
         </div> 
        </div> 
       </div> 
       <dd> 
     ...
     <div class="content_r"> 
      <dl class="job_company"> 
       <dt> 
        <a target="_blank" href="h/c/5004.jsp"> <img width="80" height="80" alt="广州百田信息科技有限公司" src="style/images/ff8080814356e881014357741e5910f1.jpg" class="b2" /> 
         <div> 
          <h2 class="fl"> 广州百田 <img width="15" height="19" alt="拉勾认证企业" src="style/images/valid.png" /> <span class="dn">拉勾认证企业</span> </h2> 
         </div> </a> 
       </dt> 
       <dd> 
        <ul class="c_feature reset"> 
         ...
         <li> <span>主页</span> <a rel="nofollow" title="http://www.100bt.com" target="_blank" href="http://www.100bt.com">http://www.100bt.com</a> </li> 
        </ul> 
        <h4>发展阶段</h4> 
        <ul class="c_feature reset"> 
         ...
         <div style="overflow: visible; position: absolute; z-index: 0; left: 0px; top: 0px; cursor: grab;">
          ...
          <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 200;">
           ...
           <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 700;">
            <span style="position: absolute; padding: 0px; margin: 0px; border: 0px none; -moz-user-select: none; cursor: pointer; background: url(style/images/img/blank.gifquot) repeat scroll 0% 0% transparent; width: 19px; height: 25px; left: 130px; top: 75px; z-index: -4626192;" "="" unselectable="on" class="BMap_Marker BMap_noprint" title=""></span>
           </div>
           ...
           <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 400;">
            <span style="position: absolute; padding: 0px; margin: 0px; border: 0px none; width: 0px; height: 0px; -moz-user-select: none; left: 130px; top: 75px; z-index: -4626192;" unselectable="on" class="BMap_Marker">
          ...
          <div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 2; display: block;">
           <div style="position: absolute; overflow: visible; top: 100px; left: 140px; z-index: 0; display: block;">
            <canvas style="position: absolute; width: 256px; height: 256px; left: -106px; top: -188px; background: none repeat scroll 0% 0% rgb(243, 241, 236);" width="256" height="256" id="_1_bg_12325_2569_16"></canvas>
            <canvas style="position: absolute; width: 256px; height: 256px; left: -362px; top: -188px; background: none repeat scroll 0% 0% rgb(243, 241, 236);" width="256" height="256" id="_1_bg_12324_2569_16"></canvas>
            <canvas style="position: absolute; width: 256px; height: 256px; left: -106px; top: 68px; background: none repeat scroll 0% 0% rgb(243, 241, 236);" width="256" height="256" id="_1_bg_12325_2568_16"></canvas>
            <canvas style="position: absolute; width: 256px; height: 256px; left: -362px; top: 68px; background: none repeat scroll 0% 0% rgb(243, 241, 236);" width="256" height="256" id="_1_bg_12324_2568_16"></canvas>
           </div>
           <div style="position: absolute; overflow: visible; top: 100px; left: 140px; z-index: 10; display: block;">
            <canvas style="position: absolute; width: 256px; height: 256px; left: -106px; top: -188px;" width="256" height="256" id="_1_poi_12325_2569_16"></canvas>
            <canvas style="position: absolute; width: 256px; height: 256px; left: -362px; top: -188px;" width="256" height="256" id="_1_poi_12324_2569_16"></canvas>
            <canvas style="position: absolute; width: 256px; height: 256px; left: -106px; top: 68px;" width="256" height="256" id="_1_poi_12325_2568_16"></canvas>
            <canvas style="position: absolute; width: 256px; height: 256px; left: -362px; top: 68px;" width="256" height="256" id="_1_poi_12324_2568_16"></canvas>
           </div>
          </div>
      ...
      <div id="myRecommend_jd"> 
       ...
       <ul class="reset"> 
        <li> <a target="_blank" href="h/jobs/148004.jsp"> <span class="f14">产品经理</span> <span class="c7">短讯神州</span> <em>92%</em> </a> </li> 
        <li> <a target="_blank" href="h/jobs/46793.jsp"> <span class="f14">产品经理</span> <span class="c7">爱拍</span> <em>89%</em> </a> </li> 
        <li> <a target="_blank" href="h/jobs/99307.jsp"> <span class="f14">产品经理</span> <span class="c7">一彩票</span> <em>88%</em> </a> </li> 
        <li> <a target="_blank" href="h/jobs/147510.jsp"> <span class="f14">产品经理</span> <span class="c7">林安集团</span> <em>88%</em> </a> </li> 
        <li> <a target="_blank" href="h/jobs/146995.jsp"> <span class="f14">产品经理</span> <span class="c7">鼎梵数码科技</span> <em>87%</em> </a> </li> 
       </ul> 
       <a target="_blank" class="more" href="h/jobs/mList.jsp">更多推荐职位&gt;&gt;</a> 
      </div>
      <!--end #myRecommend--> 
      <a class="eventAd" target="_blank" href="h/subject/s_zhouyou.jsp?utm_source=BD__lagou&amp;utm_medium=&amp;utm_campaign=zhouyou"> <img width="280" height="135" src="style/images/zhouyou.jpg" /> </a> 
     </div> 
    </div> 
    ...
    <div style="display:none;"> 
        ...
        <tr> 
         <td> 
          <form class="resumeSetForm" id="resumeSetForm"> 
           <label class="radio"> <input type="radio" value="1" class="resume1" name="resumeName" /> 在线简历： <span title="jason的简历">jason的简历</span> </label> 
           <div class="setBtns"> 
            <a target="_blank" href="h/resume/preview.jsp">预览</a> | 
           ...
           <div class="setBtns"> 
            <a class="downloadResume dn" href="h/nearBy/downloadResume">下载</a> 
            <span class="dn">|</span> 
     ...
     <div style="height:240px;" class="popup" id="loginPop"> 
      <form id="loginForm"> 
       ...
       <a class="fr" href="h/reset.jsp">忘记密码？</a> 
      ...
      <div class="login_right"> 
       ...
       <a title="使用新浪微博帐号登录" class="icon_wb" target="_blank" href="h/ologin/auth/sina.jsp"></a> 
       <a title="使用腾讯QQ帐号登录" target="_blank" class="icon_qq" href="h/ologin/auth/qq.jsp"></a> 
      </div> 
     </div>
     <!--/#loginPop--> 
     <!-- 投简历成功前填写基本信息 --> 
    ...
    #colorbox, #cboxOverlay, #cboxWrapper{overflow:visible;}
     ...
     <div class="popup" id="deliverResumeConfirm"> 
      <table width="100%"> 
       <tbody>
        ...
        <tr> 
         <td align="center"> <input type="hidden" value="" name="type" /> <a class="btn" href="javascript:sendResume(314873,22194,true,true);">确认投递</a> <a class="btn_s" href="javascript:;">放弃投递</a> <a class="f20 edit_field" href="javascript:;">修改信息</a> </td> 
        </tr> 
       </tbody>
      </table> 
     </div>
     ...
     <div style="width:440px;padding-bottom:10px;" class="popup" id="deliverResumesSuccess"> 
      <table width="100%"> 
       <tbody>
        <tr class="drawGGJ"> 
         <td align="center"> <p class="font_16 count"></p> <p class="font_16 share dn">邀请好友成功注册拉勾，可提升每日投递量 &nbsp;&nbsp; <a target="_blank" href="h/share/invite.jsp">邀请好友&gt;&gt;</a></p> </td> 
        </tr> 
        <tr class="drawQD"> 
         <td align="center"><a class="btn_s" href="javascript:top.location.reload();">确&nbsp;定</a></td> 
        </tr> 
      ...
      <table width="100%"> 
       <tbody>
        ...
        <tr> 
         <td align="center"> 
          <form> 
           <a class="btn_addPic" href="javascript:void(0);"> <span>选择上传文件</span> <input type="file" onchange="file_check(this,'h/nearBy/updateMyResume.json','resumeUpload2')" class="filePrew" id="resumeUpload2" name="newResume" size="3" title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M" /> </a> 
          </form> <a target="_blank" href="jianli.jsp" class="btn">完善在线简历</a> </td> 
        </tr> 
       </tbody>
      </table> 
     </div>
...
$(function(){
    ...
    <script src="http://api.map.baidu.com/api?v=2.0&amp;ak=A2c1a1ff1fe0750e3290660295aac602" type="text/javascript"></script>
    <script src="http://api.map.baidu.com/getscript?v=2.0&amp;ak=A2c1a1ff1fe0750e3290660295aac602&amp;services=&amp;t=20140617153133" type="text/javascript"></script> 
    <script type="text/javascript">
		//百度地图API功能
  ...
  <div id="footer"> 
   <div class="wrapper"> 
    ...
    <a target="_blank" href="h/af/zhaopin.jsp">公司导航</a> 
