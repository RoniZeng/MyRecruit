     ...
     <div class="content_l"> 
      <div class="c_detail"> 
       <div style="background-color:#fff;" class="c_logo"> 
        <a title="上传公司LOGO" id="logoShow" class="inline cboxElement" href="#logoUploader"> <img width="190" height="190" alt="公司logo" src="style/images/logo_default.png" /> <span>更换公司图片<br />190px*190px 小于5M</span> </a> 
       </div> 
       ...
       <div class="c_box companyName"> 
        ...
        <form class="clear editDetail dn" id="editDetailForm" style="display: none;"> 
         ...
         <input type="text" placeholder="一句话描述公司优势，核心价值，限50字" maxlength="50" value="测试的发打发打发大范德萨发" name="companyFeatures" id="companyFeatures" class="valid" />
         <span for="companyFeatures" generated="true" class="error" style="display: none;">请输入5-50字的一句话介绍</span> 
        ...
        <div class="clear oneword" style="display: block;">
         <img width="17" height="15" src="style/images/quote_l.png" />&nbsp; 
         <span>公司名称公司名称公司名称</span> &nbsp;
         ...
         <dd> 
          <form method="post" class="productForm"> 
           ...
           <div class="cp_intro"> 
            ...
            <textarea placeholder="请简短描述该产品定位、产品特色、用户群体等" maxlength="500" value="随便写" class="s_textarea valid" name="productProfile">随便写</textarea> 
        ...
        <dl class="c_section newIntro dn" style="display: none;"> 
         ...
         <dd> 
          <form id="companyDesForm"> 
           <textarea placeholder="请分段详细描述公司简介、企业文化等" name="companyProfile" id="companyProfile" class="valid">随便写</textarea> 
           <div class="word_count fr">
            你还可以输入 
            <span>955</span> 字
           </div> 
        ...
        <form id="tagForms"> 
         <table> 
          <tbody>
           <tr> 
            <td>地点</td> 
            <td> <input type="text" placeholder="请输入地点" value="上海" name="city" id="city" class="valid" /> </td> 
           </tr> 
           <tr> 
            <td>领域</td>
            <!-- 支持多选 --> 
            <td> <input type="hidden" value="移动互联网" id="industryField" name="industryField" class="valid" /> <input type="button" style="background:none;cursor:default;border:none !important;" disable="disable" value="移动互联网" id="select_ind" class="select_tags" /> 
           ...
           <tr> 
            <td>规模</td> 
            <td> <input type="hidden" value="150-500人" id="companySize" name="companySize" class="valid" /> <input type="button" value="150-500人" id="select_sca" class="select_tags" /> 
           ...
           <tr> 
            <td>主页</td> 
            <td> <input type="text" placeholder="请输入网址" value="http://www.weimob.com" name="companyUrl" id="companyUrl" class="valid" /> </td> 
           </tr> 
          </tbody>
         </table> 
       ...
       <dd> 
        ...
        <form class="dn" id="stageform"> 
         ...
         <ul id="stagesList" class="reset"> 
          <li> <label>融资阶段</label> <input type="hidden" class="select_invest_hidden" name="select_invest_hidden" /> <input type="button" value="融资阶段" class="select_tags_short select_invest" /> 
           ...
           </div> <label>投资机构</label> <input type="text" placeholder="如真格基金" name="stageorg" value="" /> </li> 
         </ul> 
         <input type="submit" value="保存" class="btn_small" /> 
         ...
         <div class="member_wrap"> 
          ...
          <div class="member_info newMember dn"> 
           <form class="memberForm"> 
            ...
            <textarea placeholder="请输入创始人个人简介" maxlength="500" class="s_textarea valid" name="remark">随便写</textarea> 
            <div class="word_count fr">
             你还可以输入 
             <span>476</span> 字
            </div> 
          ...
          <div class="member_info"> 
           ...
           <div class="m_name">
            随便写
            <a target="_blank" class="weibo" href="http://www.zmtpost.com"></a>
           </div> 
       ...
       <dl class="c_section c_reported"> 
        ...
        <dd> 
         ...
         <ul class="newReport dn"> 
          <li> <a style="display:none;" class="article" title="" target="_blank"></a> <a title="编辑报道" class="c_edit dn" href="javascript:;"></a> 
