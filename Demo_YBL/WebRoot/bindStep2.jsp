...
<html xmlns:wb="http://open.weibo.com/wb">
	<head>
		...
		<title>开通招聘服务-医伯乐-最专业的医药招聘平台</title>
	...
	<body>
				...
				<div class="content_mid">
					...
					<dl class="c_section c_section_service">
						...
						<dd>
							...
							<form action="bindStep3.jsp" class="corp_form" id="companyNameForm">
								...
								<span role="status" aria-live="polite" class="ui-helper-hidden-accessible">测试公司</span><input type="text" value=""
								 placeholder="请输入与公司营业执照一致的公司全称" name="companyName" id="companyName" class="valid ui-autocomplete-input"
								 autocomplete="off">
		...
		<div id="footer">
			<div class="wrapper">
				...
				<div class="copyright">&copy;2018-2020 <a href="http://www.miitbeian.gov.cn/state/outPortal/loginPortal.action"
		...
		<ul class="ui-autocomplete ui-front ui-menu ui-widget ui-widget-content ui-corner-all" id="ui-id-1" tabindex="0"
		 style="display: none; top: 356px; left: 377.5px; width: 590px;">
			<li class="ui-menu-item" role="presentation"><a id="ui-id-3" class="ui-corner-all" tabindex="-1">创建名为"测试公司"的新公司</a></li>
		</ul>
	</body>
</html>
