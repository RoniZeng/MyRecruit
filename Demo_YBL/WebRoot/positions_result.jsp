...
function downline(obj){
	document.getElementById("form"+obj).remove();
	$.post("downline.action",{"comRecId":obj},function(data){});
}
</script>
<dl class="company_center_content">
	<dt>
		<h1>
			<em></em> 有效职位 <span>（共<i style="color:#fff;font-style:normal"
			...
			<form action="tmee.actions" method="post" id="form<s:property value="#obj.id"/>">
				...
				<ul class="reset my_jobs">
					<li data-id="149594">
						...
						<div class="links">
							<a class="job_offline" onclick="downline(<s:property value="#obj.id"/>);" >下线</a>
						</div>
					</li>
				</ul>
			</form>
