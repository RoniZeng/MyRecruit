...
<html xmlns:wb="http://open.weibo.com/wb">
 <head> 
  ...
  <title>我的投递记录-招聘服务-医伯乐-最专业的医药招聘平台</title> 
...
var youdao_conv_id = 271546; 
 ...
 <body> 
  <div id="body"> 
   <div id="header"> 
    <div class="wrapper"> 
     <a class="logo" href="index.jsp"> <img width="229" height="43" alt="拉勾招聘-专注互联网招聘" src="style/images/logo.png" /> </a> 
     ...
     <dl class="collapsible_menu"> 
      ...
      <dd style="display: none;">
       <a rel="nofollow" href="jianli1.jsp">我的简历</a>
      </dd> 
      <dd style="display: none;">
       <a href="collections.jsp">我收藏的职位</a>
      </dd> 
      <dd style="display: none;">
       <a href="toudi.jsp">我投递的职位 <span id="noticeNo" class="red dn">(0)</span></a>
      </dd> 
    ...
    <div class="clearfix"> 
      ...
      <dl class="c_delivery"> 
       ...
       <dd> 
        <div class="delivery_tabs"> 
         <ul class="reset"> 
          <li class="current"> <a href="delivery.jsp?tag=-1">全部</a> </li> 
          <li> <a href="delivery.jsp?tag=5">投递成功</a> </li> 
          <li> <a href="delivery.jsp?tag=1">被查看</a> </li> 
          <li> <a href="delivery.jsp?tag=2">通过初筛</a> </li> 
          <li> <a href="delivery.jsp?tag=3">通知面试</a> </li> 
          <li class="last"> <a href="delivery.jsp?tag=4">不合适</a> </li> 
         </ul> 
        </div> 
        <form id="deliveryForm"> 
         <ul class="reset my_delivery"> 
          <li> 
           <div class="d_item"> 
            <h2 title="随便写"> <a target="_blank" href="http://www.lagou.com/jobs/149594.jsp"> <em>随便写</em> <span>（1k-2k）</span> 
              <!--  --> </a> </h2> 
            <div class="clear"></div> 
            <a title="公司名称" class="d_jobname" target="_blank" href="http://www.lagou.com/c/25927.jsp"> 公司名称 <span>[上海]</span> </a> 
     ...
     <div class="content_r"> 
      ...
      <div class="mycenterR" id="myRecommend"> 
       ...
       <ul class="reset"> 
        <li> <a target="_blank" href="http://www.lagou.com/jobs/22194.jsp"> <span class="f16">产品经理</span> <span class="c7">A</span> <em>92%</em> </a> </li> 
        <li> <a target="_blank" href="http://www.lagou.com/jobs/148004.jsp"> <span class="f16">产品经理</span> <span class="c7">B</span> <em>92%</em> </a> </li> 
        <li> <a target="_blank" href="http://www.lagou.com/jobs/46793.jsp"> <span class="f16">产品经理</span> <span class="c7">C</span> <em>89%</em> </a> </li> 
        <li> <a target="_blank" href="http://www.lagou.com/jobs/99307.jsp"> <span class="f16">产品经理</span> <span class="c7">D</span> <em>88%</em> </a> </li> 
        <li> <a target="_blank" href="http://www.lagou.com/jobs/147510.jsp"> <span class="f16">产品经理</span> <span class="c7">E</span> <em>88%</em> </a> </li> 
       </ul> 
      ...
      <dd> 
       <form id="recordForm"> 
        ...
        <ul id="interviewResult" class="record_radio clearfix"> 
         <li class="mr35"> 已收到offer <input type="radio" name="type" value="1" /> </li> 
         <li> 未收到offer <input type="radio" name="type" value="2" /> </li> 
        </ul> 
        <div class="dividebtm"> 
         <table> 
          <tbody>
           <tr> 
            ...
            <td> 
             <ul id="recordStarSelect"> 
              ...
              <li></li> 
              <li></li> 
             </ul> <input type="hidden" id="recordStar" value="" name="recordStar" /> 
             <div class="clear"></div> </td> 
           </tr> 
           <tr> 
            <td valign="top" align="right" class="dividebtman">面试短评：</td> 
            <td> <input type="hidden" class="error" id="select_record_hidden" value="" name="record" /> <input type="text" autocomplete="off" placeholder="15字以内对面试的简单描述哦" id="select_record" class="selectr_340" maxlength="15" /> 
           ...
           <tr> 
            ...
            <td> <textarea id="interviewDesc" placeholder="记录下自己的面试经历" style="width: 320px;"></textarea> 
             <div class="word_count">
              你还可以输入 
              <span>500</span> 字
             </div> 
             <div id="showName" class="f14 c7"> 
              <label class="checkbox"> <input type="checkbox" /> <i></i> </label> 匿名提交 
             </div> <input type="hidden" value="" id="isShowName" /> <input type="hidden" value="" id="senduid" /> <input type="hidden" value="" id="poid" /> <input type="hidden" value="" id="deid" /> </td> 
           </tr> 
           <tr> 
            <td align="right" colspan="2"> <input type="submit" value="确认提交" class="submitRecord btn_small" /> </td> 
           </tr> 
          </tbody>
         </table> 
        </div> 
