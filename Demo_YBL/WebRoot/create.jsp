...
<html xmlns:wb="http://open.weibo.com/wb">
 <head> 
  ...
  <title>发布新职位-招聘服务-医伯乐-最专业的医药招聘平台</title> 
...
var youdao_conv_id = 271546; 
 ...
 <body> 
  <div id="body"> 
   <div id="header"> 
    <div class="wrapper"> 
     <a class="logo" href="index.jsp"> <img width="229" height="43" alt="医伯乐-最专业的医药招聘平台" src="style/images/logo.png" /> </a> 
   ...
   <div id="container"> 
    <div class="sidebar"> 
     ...
     <div class="subscribe_side mt20"> 
      ...
      <div>
       咨询：
       <a class="f16" href="mailto:jessica@ybl.com">lrm@ybl.com</a>
      </div> 
      <div class="f18 ti2em">
       010-15935712345
      </div> 
    ...
    <div class="content"> 
     <dl class="company_center_content"> 
      ...
      <dd> 
       ...
       <form action="" method="post" class="jobForm"> 
        ...
        <table class="btm"> 
         <tbody>
          <tr> 
           ...
           <td width="85">职位类别</td> 
           <td> <input type="hidden" class="newRecpositioncategoryname" id="positionType" value="" name="positionType" /> <input type="button" value="请选择职位类别" id="select_category" class="selectr selectr_380" /> 
            <div class="dn" id="box_job" style="display: none;"> 
             <dl> 
            
              <dd> 
               <ul class="reset job_main"> 
<!--                 <li> <span>医院/临床医疗</span>  -->
...
<!--                  </ul> </li>  -->
          ...
          <tr> 
           ...
           <td>职位名称</td> 
           <td> <input type="text" placeholder="请输入职位名称，如：临床医生" value="" name="positionName" id="positionName" class="newRecpositionname" /> </td> 
          </tr> 
         </tbody>
        </table> 
        <table class="btm"> 
         <tbody>
          <tr> 
           ...
           <td> 
            <ul class="profile_radio clearfix reset"> 
             <li> 全职<em></em> <input type="radio" name="newRecjobType" value="0" /> </li> 
             <li> 兼职<em></em> <input type="radio" name="newRecjobType" value="1" /> </li> 
             <li> 实习<em></em> <input type="radio" name="newRecjobType" value="2" /> </li> 
            </ul> </td> 
          </tr> 
          ...
          <tr> 
           ...
           <td> 
            <div class="salary_range"> 
             <div> 
              <input type="text" placeholder="最低月薪" value="" id="newRecminSalary" name="salaryMin" /> 
              <span>k</span> 
             </div> 
             <div> 
              <input type="text" placeholder="最高月薪" value="" id="newRecmaxSalary" name="salaryMax" /> 
              <span>k</span> 
             </div> 
          ...
          <tr> 
           ...
           <td>工作城市</td> 
           <!-- id="workAddress" -->
           <td> <input type="text" id="newReccity" placeholder="请输入工作城市，如：北京" value="上海" name="city"  /> </td> 
          </tr> 
         </tbody>
        </table> 
        ...
        <table class="btm"> 
         <tbody>
          <tr> 
           <td width="25"><span class="redstar">*</span></td> 
           <td width="85">工作经验</td> 
           <td> <input type="hidden" class="newRecjobExperience" id="experience" value="" name="workYear" /> <input type="button" value="请选择工作经验" id="select_experience" class="selectr selectr_380" /> 
          ...
          <tr> 
           ...
           <td>学历要求</td> 
           <!--<h3><span>(最高月薪不能大于最低月薪的2倍)</span></h3> --> 
           <td> <input type="hidden" class="newRecdegree" id="education" value="" name="education" /> <input type="button" value="请选择学历要求" id="select_education" class="selectr selectr_380" /> 
         ...
         <tbody>
          <tr> 
           <td width="25"><span class="redstar">*</span></td> 
           <td width="85">职位标签</td> 
           <td> <input type="text" placeholder="描述该职位的诱惑，如：福利待遇、发展前景等" value="" name="positionAdvantage" class="input_520" id="newRectag" /> </td> 
          </tr> 
          
          <tr> 
           <td><span class="redstar">*</span></td> 
           <td>招聘人数</td> 
           <td> <input type="text" placeholder="请输入该职位所招的人数" value="" name="" class="input_520" id="newRecnum"/> </td>
           
            <tr> 
           <td><span class="redstar">*</span></td> 
           <td>职位描述</td> 
           <td> 
	           <textarea rows="3" cols="20" placeholder="描述该职位岗位职责、岗位要求等" name="" id="newRecdescription" class=""></textarea>
           </td> 
          </tr> 
           ...
           <td><span class="redstar">*</span></td> 
           <td>工作地址</td> 
           <td> <input type="text" placeholder="请输入详细的工作地址" value="" name="positionAddress" class="input_520" id="newReclocation" /> <input type="hidden" value="" name="positionLng" id="lng" /> <input type="hidden" value="" name="positionLat" id="lat" /> 
...
<!--           <tr>  -->
<!--            <td width="25"><span class="redstar">*</span></td>  -->
<!--            <td colspan="2"> 接收简历邮箱： <span id="receiveEmailVal">admin@admin.com</span> <input type="hidden" value="admin@admin.com" id="receiveEmail" name="email" /> </td>  -->
<!--           </tr> -->
           
<!--           <tr>  -->
<!--            <td width="25"></td>  -->
<!--            <td colspan="2"> 同时简历自动发送至邮箱（仅一个） <input type="text" value="" id="forwardEmail" name="forwardEmail" />  -->
<!--             <span class="error" id="beError" style="display:none"></span> </td>  -->
<!--           </tr>  -->
          
          <tr> 
           <td width="25"></td> 
           <td colspan="2"><input type="button" onclick="submitt()" value="发布" id="formSubmit" class="btn_32" /> </td> 
           <script>
           function submitt(){ 
         	 	var JT=$(".newRecjobExperience").val();
         	 	if(JT.charAt(0)=='不') JT=0;
         	 	else if(JT.charAt(0)=='应') JT=1;
         	 	else if(JT.charAt(1)=='年') JT=2;
         	 	else if(JT.charAt(0)=='1'&&JT.charAt(1)=='-') JT=3;
         	 	else if(JT.charAt(0)=='3') JT=4;
         	 	else if(JT.charAt(0)=='5') JT=5;
         	 	else JT=6; 
         	 	var DE=$(".newRecdegree").val();
         	 	if(DE.charAt(0)=='不') DE=0;
         	 	else if(DE.charAt(0)=='大') DE=1;
         	 	else if(DE.charAt(0)=='本') DE=2;
         	 	else if(DE.charAt(0)=='硕') DE=3;
         	 	else  DE=4; 
           		$.post("createReciriment.action",{
           			"newRec.position.category.name":$(".newRecpositioncategoryname").val(),
           			"newRec.position.name":$(".newRecpositionname").val(),
           			"newRec.jobType":$('input:radio[name="newRecjobType"]:checked').val(),
           			"newRec.minSalary":$("#newRecminSalary").val(),
           			"newRec.maxSalary":$("#newRecmaxSalary").val(),
           			"newRec.city":$("#newReccity").val(),
           			"newRec.jobExperience":JT,
           			"newRec.degree":DE,
           			"newRec.tag":$("#newRectag").val(),
           			"newRec.num":$("#newRecnum").val(),
           			"newRec.description":$("#newRecdescription").val(),
           			"newRec.location":$("#newReclocation").val()
           			},function(data){
           			window.location.href="index06.jsp";
           		});
           }
           </script>
          </tr> 
    ...
    <div style="display:none;"> 
     ...
     <div class="popup" id="baiduMap"> 
      ...
      <div id="allmap" style="overflow: hidden; position: relative; z-index: 0; background-color: rgb(243, 241, 236); color: rgb(0, 0, 0); text-align: left;">
       <div style="overflow: visible; position: absolute; z-index: 0; left: 0px; top: 0px; cursor: grab;">
        ...
        <div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 2; display: block;">
         <div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 0; display: block;">
          <canvas style="position: absolute; width: 256px; height: 256px; left: -74px; top: -213px; background: none repeat scroll 0% 0% rgb(243, 241, 236);" width="256" height="256" id="_1_bg_6323_2355_15"></canvas>
         </div>
         <div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 10; display: block;">
          <canvas style="position: absolute; width: 256px; height: 256px; left: -74px; top: -213px;" width="256" height="256" id="_1_poi_6323_2355_15"></canvas>
         </div>
        </div>
       ...
       <div unselectable="on" class=" BMap_scaleCtrl BMap_noprint anchorBL" style="bottom: 18px; right: auto; top: auto; left: 81px; width: 88px; position: absolute; z-index: 10; -moz-user-select: none;">
