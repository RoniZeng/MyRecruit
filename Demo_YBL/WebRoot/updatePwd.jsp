...
<html xmlns:wb="http://open.weibo.com/wb">
 <head> 
  ...
  <title>修改密码-医伯乐-最专业的医药招聘平台</title> 
   ...
   <div id="header"> 
    <div class="wrapper"> 
     ...
     <ul id="navheader" class="reset"> 
      ...
      <li> <a rel="nofollow" href="h/corpResume/unHandleResumes.jsp">简历管理</a> </li> 
   ...
   <div id="container"> 
    <div class="user_bindSidebar"> 
     <dl id="user_sideBarmenu" class="user_sideBarmenu"> 
      ...
      <dd>
       <a href="accountBind.jsp">帐号绑定</a>
      </dd> 
      <dd>
       <a class="hover" href="updatePwd.jsp">修改密码</a>
      </dd> 
     </dl> 
    </div> 
        ...
        <table class="savePassword"> 
         <tbody>
          ...
          <tr> 
           ...
           <td> <input type="password" maxlength="16" id="oldpassword" name="oldpassword" style="background-image: url(style/images/img/0CQnd2Jos49xUAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;" /> <span id="updatePwd_beError" style="display:none;" class="error"> </span></td> 
          </tr> 
          <tr> 
    ...
    <div style="display:none;"> 
     ...
     <div style="overflow:auto;" class="popup" id="bindTips"> 
      <table> 
       <tbody>
        <tr> 
         <td> <h3 id="user_hasBindAccount"> </h3> 
          <div class="f18">
           你可以：
          </div> 
        ...
        <tbody>
         ...
         <tr> 
          <td class="chooseAccount"> <label class=""> <input type="hidden" value="" /> <em></em> 
            ...
            </div> </label> <label> <input type="hidden" value="" /> <em></em> 
            <div> 
             <div class="f16 c7 ">
              保留 
         ...
         <tr> 
          <td align="center"> <a id="user_confirmReplace" class="btn" href="javascript:;">确 定</a> <a id="user_cancleReplace" class="cancel" href="javascript:;">取 消</a> </td> 
         </tr> 
        </tbody>
       </table> 
      </form> 
