			...
			<div id="header">
				<div class="wrapper">
					<a class="logo" href="index.jsp">
						<img width="229" height="43" alt="医伯乐招聘-专注医药招聘" src="style/images/logo.png">
					</a>
...
<!-- 						<li><a target="_blank" href="">论坛</a></li> -->
		...
		<div id="footer">
			<div class="wrapper">
				...
				<div class="copyright">&copy;2018-2019 <a href="http://www.miitbeian.gov.cn/state/outPortal/loginPortal.action"
