...
<dl class="company_center_content"> 
      <dt> 
       <h1> <em></em> 自动过滤简历 <span>（共<s:property value="#request.comGresList.size()" />份）</span> </h1> 
      </dt> 
      <dd> 
        ...
        <ul class="reset resumeLists"> 
         <li data-id="1686182" class="onlineResume">
          <div class="resumeShow"> 
           ...
           <div class="links"> 
            <a class="resume_notice" onclick="changeStatus(<s:property value="#obj.resume.id"/>,<s:property value="#obj.reciritment.id"/>,2);">待定</a> 
